import cv2
from playsound import playsound #libraray neede dfo playing alert sound
import pandas as pd
...
def drawboxtosafeline(image_np,p1,p2,Line_Position2,Orientation):
    ...
    if (distance_from_line <= 0) :
			 ...
			 #sound = os.path.join()
             playsound(r"C:\Users\jaikr\PycharmProjects\ShredderSystem_opencv_PlaySound\utils\alert.wav")
